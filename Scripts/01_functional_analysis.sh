...
Rscript $FUNCDIR/Gensal/03_top_ZHp.r \
...
Rscript $FUNCDIR/Gensal/03_reformat_GO.r \
-I $MYMAPPING \
-O $FORMGO
...
Rscript $FUNCDIR/Gensal/04_assign_kegg.r \
-I $FORMGO \
-O $KEGGO
...
Rscript $FUNCDIR/05_assign_kegg_pathway.r \
-I $KEGGO \
-O $PKEGG
...
Rscript $FUNCDIR/06_assign_transcript_name.r \
-I $PKEGG \
-B $MYB \
-O $WITHT
...
Rscript $FUNCDIR/07_KEGG_enrichment.r \
...
Rscript $FUNC_DIR/Gensal/09_top_hapFLK.r \
...
Rscript $FUNC_DIR/Gensal/07_KEGG_enrichment.r \
...
Rscript $FUNC_DIR/Gensal/12_top_win_ibd.r \
...
ENRICH=$INPUT_DIR/GO/win_ibd_KEGG_Enrich.txt
Rscript $FUNC_DIR/Gensal/13_add_Chr_Numb.r \
-N $NAMETONUMBERS \
-O $ENRICH
